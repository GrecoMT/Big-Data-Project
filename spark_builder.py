...
import utils
from utils import get_coordinates_osm
'''from utils import get_lat
from utils import get_lng'''
...
class SparkBuilder:
    def __init__(self, appname: str, dataset_path: str):
        ...
        #Cablaggio QueryManager in SparkBuilder in modo da avere un query manager associato alla sessione
